...
python src/Train.py --config=cfgs/wgan_cus_str/gan.yaml --trainer=cfgs/wgan_cus_str/trainer.yaml --data=cfgs/wgan_cus_str/data_loader.yaml  --seed_everything=0 --trainer.max_epochs=50 --do_attack=True --do_train=False --do_validate=False --do_test=False --data.data_dir netflix_data