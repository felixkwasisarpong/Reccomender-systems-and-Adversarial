...
python src/Train.py --config=cfgs/create_adv/synth.yaml --trainer=cfgs/create_adv/trainer.yaml --data=cfgs/data_loader.yaml --data=cfgs/data_loader.yaml --seed_everything=0 --trainer.max_epochs=50  --do_train=False --do_validate=False --do_test=False --data.data_dir netflix_data