...
# Run the script
python src/Train.py --config=cfgs/basemodel/basemodel.yaml --trainer=cfgs/basemodel/basemodel_trainer.yaml --data=cfgs/data_loader.yaml --seed_everything=0 --trainer.max_epochs=50 --do_test=True --data.data_dir netflix_data