...
#SBATCH --output=str-Dp_fm-strong.log          # Output log file
...
# Run the script
python src/Train.py --config=cfgs/dp_model/db_FM.yaml --trainer=cfgs/trainer_single_gpu.yaml --data=cfgs/data_loader.yaml --seed_everything=0 --trainer.max_epochs=50 --do_test=True --data.data_dir netflix_data