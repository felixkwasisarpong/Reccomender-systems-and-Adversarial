...
python src/Train.py --config=cfgs/wgan_dp_mid/gan.yaml --trainer=cfgs/wgan_dp_mid/trainer.yaml  --data=cfgs/wgan_dp_mid/data_loader.yaml --seed_everything=0 --trainer.max_epochs=200 --do_attack=True --do_train=False --do_validate=False --do_test=False --data.data_dir predicted_data